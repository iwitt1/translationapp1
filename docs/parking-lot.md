...
- **Why deferred:** none blocks the staging smoke; all are reloads-work-around-it gaps. **Trigger:** first multi-user testing where reload-to-see-it feels broken, or list latency shows up. See decisions.md 2026-06-12 "Phase 3 conversation-aware frontend".
