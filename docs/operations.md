...
**Last updated:** 2026-06-10 (migrations list extended through 011 — Phase 2 Step 5 social graph + safety primitives, written/pending staging gate; 007–011 flagged staging-only. Earlier same-day: 010 Step 4 discovery RPCs; 005–008 list, the `nonbinary` gender-enum regression in 008, post-008 test-user note.)
