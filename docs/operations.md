...
**Last updated:** 2026-06-10 (migrations list extended through 011 — Phase 2 Step 5 social graph + safety primitives, **gate PASSED on staging 40/40**; Step 4 gate re-passed 22/22 after the 011 block-filter amend; 007–011 flagged staging-only (prod replay pending the Phase 2 cutover). Earlier same-day: 010 Step 4 discovery RPCs; 005–008 list, the `nonbinary` gender-enum regression in 008, post-008 test-user note.)
